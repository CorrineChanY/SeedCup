...
- [ ] 8. **所有的相关get、post请求都应该做如下修改**，下面是其中一个例子
...
- [ ] 9. 有些函数是可以提取到misc目录下的utils.js里的，想想看会有哪些。举例：signup.js里的checkPhone()方法

- [ ] 10. component里的组件不知所云。Table组件不应该这么使用，也需要用Function Components来实现

- [ ] 11. **提取相同结构的标签组抽象为组件**，下面是其中一个例子
